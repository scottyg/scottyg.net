        ...
        <div class="w-full mx-auto">
          <div class="flex flex-wrap items-center justify-between">
            ...
            <div
              ...
              id="mobile-menu-3"
            >
              <ul class="flex-col md:flex-row flex items-center md:space-x-8 mt-4 md:mt-0 md:text-base md:font-medium">
                <li>
                  <a
                    href="/about"
                    class="text-gray-700 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:p-0 hover:underline"
                  >
                    About
                  </a>
                </li>
                <li>
                  <a
                    ...
                    target="_blank"
                    class="text-gray-700 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-purple-700 md:p-0"
                  >
                    <svg
                      width="256px"
                      height="250px"
                      ...
                      class="w-6 h-6 text-black hover:text-gray-500 fill-current stroke-transparent"
                    >
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      preserveAspectRatio="xMidYMid"
                      class="w-6 h-6  text-blue-700 hover:text-blue-500 fill-current stroke-transparent rounded-sm"
                    >
                      <g>
                        <path
